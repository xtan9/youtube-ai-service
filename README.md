...
Node.js 22 with npm 10, Hono, Python (faster-whisper), yt-dlp, ffmpeg, `eld` for text-based language detection (with a CJK Unicode-script fallback for short titles where eld is unreliable). Runs in Docker.
